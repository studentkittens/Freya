...
FreyaAvahiView::FreyaAvahiView(void) : m_Button_Cancel("Cancel"), m_Button_Select("Select"), m_Status_Label("Searching..   ")
{
    ...
    // Signals
    m_Button_Cancel.signal_clicked().connect(sigc::mem_fun(*this,&FreyaAvahiView::on_button_cancel));
    m_Button_Select.signal_clicked().connect(sigc::mem_fun(*this,&FreyaAvahiView::on_button_select));
...
/// DTor ///
FreyaAvahiView::~FreyaAvahiView(void) {}

/// Event Callbacks ////

void FreyaAvahiView::on_button_cancel(void)
{
    hide();
}

void FreyaAvahiView::on_button_select(void)
{
...
/* Delete a certain IP */
void FreyaAvahiView::server_append(const char * ip, const char * hostname, const char * name, unsigned int port)
{
...
/* Delete a certain IP */
void FreyaAvahiView::server_delete(const char * name)
{
...
/* Set status label */
void FreyaAvahiView::set_status(const char * message)
{
