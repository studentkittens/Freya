...
Funktionen zum Bearbeiten der Queue. queue_add() nimmt dabei ein Pfad zu einem Song oder einem Verzeichniss in der Datenbank 
und fügt ihm rekursiv der Queue hinzu. Das Wurzelverzeichniss ist dabei '/'.
queue_clear() teilt dem Server mit die Queue zu leeren.
queue_delete() löscht den Song der an der Stelle 'pos' steht. 
\begin{verbatim}
