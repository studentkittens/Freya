...
\begin{itemize}
    ...
    \item Die set\_value(url, wert) Methode holt sich mit cfgmodel.getDocPtr() einen aktuellen Dokument Pointer über die Model
...
\begin{itemize}
    \item Das Makro \verb+CONFIG_GET("settings.connection.host")+ wird analog dem Setzen aufgerufen, dieses ruft die entsprechende Wrapper
        ...
        Konfigurationsdatei zeigt, oder der Custom User Config Pointer gelanden werden soll.
