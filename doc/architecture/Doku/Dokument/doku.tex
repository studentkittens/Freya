...
\input{./tex/wasserfallmodell}
\input{./tex/richtlinien}
\input{./tex/definition}
\part{Lastenheft}
\input{./tex/lastenheft}
\part{Pflichtenheft}
\input{./tex/pflichtenheft}
\input{./tex/testfaelle}
\part{Designdokument}
\input{./tex/designdokument}
\input{./tex/config}
\input{./tex/clientimplementierung}
\input{./tex/guielements}
\input{./tex/browserimplementierungen}
\input{./tex/weiteres}
\input{./tex/glossar}
\part{Epilog}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[scale=0.5]{./gfx/misc/final_result.png}
...
\begin{itemize}
    \item \textbf{Lasten und Pflichtenheft:}, M. Tigges
    \item \textbf{Diagramme:} Eduard Schneider, M. Tigges
    \item \textbf{Dokumentation (Designdokument etc.):} C. Pahl, C. Piechula, E. Schneider
    \item \textbf{Entwicklung und Softwaredesign:} C. Pahl, C. Piechula, E. Schneider
    \item \textbf{Entwicklungsumgebung:} (CMake, git): C. Pahl, C. Piechula 
\end{itemize}
