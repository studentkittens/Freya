...
\subsection{Hardware}
Die Anforderungen and die Hardware sind so gering, dass sie nicht erwähnenswert sind.
Selbst Smartphones der unteren Klass verfügen über mehr als genug Leistung, um den 
Freya MPD-Client nutzen zu können.
\subsection{Orgware}
Orgware ist für die Anwendung des MPD-Clients nicht von nöten.
