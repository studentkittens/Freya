...
Als Netzwerkprotokoll wird das MPD eigene Protokoll verwendet. \footnote{\url{http://www.musicpd.org/doc/protocol/index.html}}
...
\begin{quote}
    ...
    \footnote{Zitat aus: \url{http://de.wikipedia.org/wiki/Music\_Player\_Daemon}}
\end{quote}
...
\end{figure}
\footnote{Bild-Quelle: \url{http://images.wikia.com/mpd/images/6/68/Mpd-overview.png}}
