...
\begin{itemize}
	...
	\item Klassenname der jeweiligen Testsuite \verb+ <Name des Namespaces>TestSuite+
...
\end{lstlisting}
\section{Doxygen}
Als interne Entwicklerdokumentation soll das Tool Doxygen\footnote{\url{http://www.stack.nl/~dimitri/doxygen/}} verwendet werden.
...
\emph{Literate programming}\footnote{\url{http://en.wikipedia.org/wiki/Literate\_programming}} dient laut Prof. Donald E. Knuth\footnote{\url{http://de.wikipedia.org/wiki/Donald\_Ervin\_Knuth}} 
