...
namespace Browser
{
PlaylistManager::PlaylistManager(MPD::Client& client, Glib::RefPtr<Gtk::Builder>& builder,GManager::BrowserList& list) :
    AbstractBrowser(list,"Playlists",true,true,Gtk::Stock::INDENT),
